    ...
    return (
        <>
            ...
            <div className='content-wrapper'>
                ...
                <CTA text='Mamy nadzieję, że odnajdą Państwo produkt idealny dla siebie. Jeżeli nie to z przyjemnością przygotujemy taki specjalnie na Państwa zamówienie.' />
                <Service />
            </div>

            <section className='thermovision'>
                <h5>Termowizja</h5>
            ...
            <CTA text='Dołącz do nas już dziś (w nocy), zrozum naszą pasję i oglądaj świat na zielono.' />
        </>
